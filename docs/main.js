...
var _lucamug$elm_spa_seo_testing$Main$initModel = {api2Data: '', cookies: ''};
var _lucamug$elm_spa_seo_testing$Main$view = function (model) {
	return A2(
		...
		A2(
			...
			{ctor: '[]'},
			_mdgriffith$stylish_elephants$Element$text('ciao')));
};
var _lucamug$elm_spa_seo_testing$Main$fromAppToJs = _elm_lang$core$Native_Platform.outgoingPort(
	'fromAppToJs',
	function (v) {
		return v;
	});
var _lucamug$elm_spa_seo_testing$Main$requestCookies = function (model) {
	return _lucamug$elm_spa_seo_testing$Main$fromAppToJs('give me cookies!');
};
var _lucamug$elm_spa_seo_testing$Main$fromJsToApp = _elm_lang$core$Native_Platform.incomingPort('fromJsToApp', _elm_lang$core$Json_Decode$string);
var _lucamug$elm_spa_seo_testing$Main$Model = F2(
	function (a, b) {
		return {api2Data: a, cookies: b};
	});
...
var _lucamug$elm_spa_seo_testing$Main$HereAreYourCookies = function (a) {
	return {ctor: 'HereAreYourCookies', _0: a};
};
var _lucamug$elm_spa_seo_testing$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _lucamug$elm_spa_seo_testing$Main$fromJsToApp(_lucamug$elm_spa_seo_testing$Main$HereAreYourCookies),
			_1: {ctor: '[]'}
		});
};
...
var _lucamug$elm_spa_seo_testing$Main$initCmd = _elm_lang$core$Platform_Cmd$batch(
	{
		ctor: '::',
		_0: A2(
			_elm_lang$core$Task$perform,
			function (_p0) {
				return _lucamug$elm_spa_seo_testing$Main$FetchApi2Data('https://httpbin.org/cookies/set?name2=value2');
			},
			_elm_lang$core$Process$sleep(0.0 * _elm_lang$core$Time$second)),
		_1: {ctor: '[]'}
	});
var _lucamug$elm_spa_seo_testing$Main$init = {ctor: '_Tuple2', _0: _lucamug$elm_spa_seo_testing$Main$initModel, _1: _lucamug$elm_spa_seo_testing$Main$initCmd};
...
var _lucamug$elm_spa_seo_testing$Main$update = F2(
	function (msg, model) {
		var _p1 = A2(_elm_lang$core$Debug$log, 'xxx', msg);
		switch (_p1.ctor) {
			case 'ChangeLocation':
				return {
					ctor: '_Tuple2',
			...
			case 'NewApi2Data':
				...
				if (_p2.ctor === 'Ok') {
					...
					return {
						ctor: '_Tuple2',
						_0: newModel,
						_1: _lucamug$elm_spa_seo_testing$Main$requestCookies(newModel)
					};
				} else {
			...
			case 'FetchApi2Data':
				return {
					...
					_1: A2(
						...
						A2(_elm_lang$http$Http$get, _p1._0, _lucamug$elm_spa_seo_testing$Main$api2Decoder))
				};
			default:
				return {
					ctor: '_Tuple2',
...
var _lucamug$elm_spa_seo_testing$Main$main = _elm_lang$html$Html$program(
...
if (typeof _lucamug$elm_spa_seo_testing$Main$main !== 'undefined') {
    _lucamug$elm_spa_seo_testing$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Main.Msg":{"args":[],"tags":{"HereAreYourCookies":["String"],"NewApi2Data":["Result.Result Http.Error Main.Api2Data"],"ChangeLocation":["String"],"FetchApi2Data":["String"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Main.Api2Data":{"args":[],"type":"{ url : String }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
